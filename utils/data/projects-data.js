export const projectsData = [
    {
       id: 1,
        ...
        realisation: "1.J’ai étudié les textes de lois pour calibrer des questions auxquels les utilisateurs devront répondre."+ 
            +"<br>"+"2.Les utilisateurs enregistrent dans un questionnaire détaillé des informations concernant leur IA tel que le but,"+
       " les données récoltées pour son entrainement ainsi que leur utilisation."+"<br>3.J’ai ensuite étudié des solutions possibles ;"+
"nous souhaitions partir sur le même principe qu’une des IA utilisé au sein de l’organisme. "+
    ...
    },
    {
        ...
        realisation: "<br>1.Après l’installation des Machines virtuelle, nous avons installé les serveur apache et les extensions php, MySQL."+
            "<br>2. Ensuite nous avons installé le GLPI et configuré les droits administrateur et la création de compte."+
            "<br>3. Nous avons ensuite réalisé une base de donnés manuellement et tester les fonctions de ticketing.",
